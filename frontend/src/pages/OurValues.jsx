...
// const SectionCard = ({ title, children, icon: Icon, direction }) => (
//   <motion.div
...
//    const sections = [
//     { key: "competitivenessDimensions", icon: Lightbulb },
//     { key: "profitabilityDimensions", icon: DollarSign },
//     { key: "growthIndicatorsTitle", icon: TrendingUp },
//     { key: "impactDimensionsTitle", icon: Users },
//   ];
