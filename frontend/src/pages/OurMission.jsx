      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-16">
        ...
        <div className={`flex-1 ${isRTL ? 'text-right' : 'text-left'} space-y-9 `}>
          ...
          {[t('ourMission.paragraph1'), t('ourMission.paragraph2'), t('ourMission.paragraph3'), t('ourMission.paragraph4')].map((text, index) => {
            const icons = [
              <IoBook key="icon1" className="text-yellow-500  w-10 h-10" size={40} />,
        ...
        >
            ...
            src={OurMissions}
            alt="Our Mission"
            className="w-full h-auto max-w-sm sm:max-w-md md:max-w-lg lg:max-w-lg
             xl:max-w-xl
             mx-auto rounded-xl object-cover transition-transform duration-500 hover:scale-105"
          /> 
