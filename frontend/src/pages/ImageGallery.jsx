  ...
  return (
    <div className="relative px-4 py-16 max-w-7xl mx-auto">
      ...
      {sections.map((sectionKey) => {
        ...
        return (
          <motion.div key={sectionKey} className="mb-16">
            {/* Section heading animation */}
            <motion.h3
              className="text-2xl md:text-3xl font-bold mb-6 text-yellow-700"
            ...
            {/* EVENTS section with subcategory links */}
            {sectionName === 'events' ? (
              <div className="mb-8">
                <p className="text-gray-700 text-lg mb-4">{t('photos')}</p>
                <div className="flex flex-wrap gap-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {imageData
                  ...
                  .map((img, index) => (
                    <motion.div
                      key={index}
                      className="cursor-pointer relative group overflow-hidden rounded-2xl shadow-lg"
                      onClick={() => setSelectedImg(img)}
                      variants={fadeInZoom}
                      initial="hidden"
                      whileInView="visible"
