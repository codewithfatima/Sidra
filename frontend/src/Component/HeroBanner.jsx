    ...
    <div className="relative w-full h-[90vh] ">
      ...
      {/* Image */}
       <img
        ...
        alt={`Slide ${current + 1}`}
        className="w-full h-full mt-16 object-cover transition-opacity duration-700"
      />

      {/* Overlay title */}
      {/* <div className="absolute inset-0 bg-black/70 flex items-center justify-center ">
        <h2 className="text-[#f5bc00] text-2xl md:text-4xl font-almarai font-bold text-center px-4 max-w-2xl">
